...
Widget::Widget(QWidget* parent)
    : QWidget(parent), ui(new Ui::Widget), settings(new Settings),
...
void Widget::on_startButton_clicked() { ui->stackedWidget->setCurrentIndex(1); }
...
void Widget::on_quitButton_clicked() { this->close(); }

void Widget::on_settingsButton_clicked() {
  ui->stackedWidget->setCurrentIndex(2);
}

void Widget::on_pushButton_clicked() { ui->stackedWidget->setCurrentIndex(0); }

void Widget::on_checkSound_stateChanged(int arg1) { settings->setSound(arg1); }
...
void Widget::on_helpButton_clicked() { ui->stackedWidget->setCurrentIndex(4); }

void Widget::on_buttonBox_accepted() { ui->stackedWidget->setCurrentIndex(1); }

void Widget::on_buttonBox_rejected() { ui->stackedWidget->setCurrentIndex(0); }
...
void Widget::on_Give_up_clicked() {
  if (!score->isSuccessful()) {
    ...
    QString username = diag.getText(this, tr(" "), tr("Username: "),
                                    QLineEdit::Normal, "", &ok);

...
{
    SECTION("Ukoliko pozovemo kostruktor sa argumentom 100, ocekujemo da width bude 75")
    {
        // Arrange
    ...
    SECTION("Ukoliko pozovemo kostruktor sa argumentom 120, ocekujemo da height bude 90")
    {
        // Arrange
...
TEST_CASE("move", "[function]")
{
    ...
    SECTION("Ocekujemo da ce se nakon 5 iteracija x koordinata uvecati za 5, a y smanjii za 5")
    {
        // Arrange
        DirtyBubble *dirtybubble = new DirtyBubble(100);
        qreal x = dirtybubble->x();

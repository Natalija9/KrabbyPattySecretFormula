...
{
    SECTION("Kada se kreira nova instanca sirina slike se postavlja na sirinu igraca")
    {
...
//        assert
    ...
    SECTION("Kada se kreira nova instanca visina slike se postavlja na sirinu igraca")
    {

...
{
    SECTION("Za prosledjenu sirinu igraca, konstruise se Karen prepreka skalirane visine")
    {
        // Arrange
    ...
    SECTION("Za prosledjenu sirinu igraca, konstruise se Karen prepreka skalirane sirine")
    {
        // Arrange
...
TEST_CASE("Funkcija move()","[function]")
{
    ...
    SECTION("Nakon 10 koraka(iteracija), prepreka umanjuje svoju x koordinatu za 20, a y ostaje nepromenjena")
    {
        //Arrange
        Karen *karen = new Karen(10);

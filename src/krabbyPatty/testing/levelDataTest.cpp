...
{
    SECTION("Kada se kreira nova instanca, dimenzije ekrana su pozitivni brojevi")
    {
//        arrange
...
//        act and assert
    ...
    SECTION("za validnu vrednost nivoa funkcija vraca odgovarajucu sliku pozadine")
    {
//        arrange
        Settings *settings = new Settings();
        LevelData *levelData = new LevelData(settings);
...
//        act and assert
    ...
    SECTION("za validnu vrednost nivoa funkcija vraca odgovarajucu sliku plocica")
    {
//        arrange
        Settings *settings = new Settings();
        LevelData *levelData = new LevelData(settings);
